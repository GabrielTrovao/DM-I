...
####
Correlation <- select(test, "date", "AQI")
Correlation$Predictions <- predict$net.result
Correlation$Rate <- test$AQI / predict$net.result
Correlation
Accuracy <- nrow(subset(Correlation,Rate >= 0.90 & Rate <= 1.10,Rate))/nrow(Correlation)
Accuracy
